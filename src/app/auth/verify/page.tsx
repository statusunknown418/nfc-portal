...
export default function VerifyPage() {
  return (
    <section className="grid h-screen place-items-center bg-muted/50">
      <Card className="max-w-lg bg-background text-center">
        ...
        <CardContent className="flex flex-col gap-2">
          <CardDescription>
            Check your inbox for a verification email from us, you just need to
            click the button to be redirected back to the admin page.
          </CardDescription>
